...
export function AutoLockProvider({ children }: { children: ReactNode }) {
    ...
    const enterStealth = () => setIsStealth(true);
    const exitStealth = () => setIsStealth(false);

    return (
        <AutoLockContext.Provider value={{ lockVault, panicLock, autoLockMinutes, setAutoLockMinutes, isStealth, enterStealth, exitStealth }}>
            {children}
